...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.34-kirby-problem-4.34-4698ede1-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.34"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.34-kirby-problem-4.34-4698ede1-v1",
      "problem_contract_sha256": "31b38d03b15d1a3ae9ec2c8c9bd188621902596b9bafa0836be10f8e78304a7f",
      "problem_id": "problem:um-kp-4.34-kirby-problem-4.34-4698ede1",
      "route_id": "route:um-kp-4.34-kirby-problem-4.34-4698ede1-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.34-kirby-problem-4.34-4698ede1-source-fidelity-01",
      "graph_id": "graph:um-kp-4.34-kirby-problem-4.34-4698ede1-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.34-kirby-problem-4.34-4698ede1-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.34-kirby-problem-4.34-4698ede1-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $\\Sigma$ be a surface embedded in $S^{4}$. Can $\\Sigma$ be unknotted by a sequence of torus surgeries in its complement, such that the ambient manifold is always $S^{4}$?"
          },
          "statement_sha256": "f7b4e3281faebd98e4a5ade211673d318618551d2352941fad03caab3cbac0b1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.34-kirby-problem-4.34-4698ede1-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.34-kirby-problem-4.34-4698ede1-root",
      "route_id": "route:um-kp-4.34-kirby-problem-4.34-4698ede1-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.34-0dc767a7ea59",
        "url": "https://www.unsolvedmath.com/problems/KP-4.34"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
